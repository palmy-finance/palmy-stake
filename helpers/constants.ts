  ...
  getParamPerNetwork<tEthereumAddress>(
    {
      ...
      [eOasysNetwork.astar]: '0xc4335B1b76fA6d52877b3046ECA68F6E708a27dd',
      [eOasysNetwork.shiden]: '0xb163716cb6c8b0a56e4f57c394A50F173E34181b',
      [eOasysNetwork.shibuya]: '0xEB741C051E474f83cff38B44A912281772C23CE6',
    },
    network
  );
  ...
  getParamPerNetwork<string>(
    {
      ...
      [eOasysNetwork.astar]: '864000', // Dummy
      [eOasysNetwork.shiden]: COOLDOWN_SECONDS, // Dummy
      [eOasysNetwork.shibuya]: COOLDOWN_SECONDS, // Dummy
    },
    network
  );
  ...
  getParamPerNetwork<string>(
    {
      ...
      [eOasysNetwork.astar]: '172800', // 2d
      [eOasysNetwork.shiden]: UNSTAKE_WINDOW, // Dummy
      [eOasysNetwork.shibuya]: UNSTAKE_WINDOW, // Dummy
    },
    network
  );
  ...
  getParamPerNetwork<tEthereumAddress>(
    {
      ...
      [eOasysNetwork.astar]: '0xed81c007113D8E532954B735B683260776F3c297', // Emission manager
      [eOasysNetwork.shiden]: '0x50414Ac6431279824df9968855181474c919a94B', // Deployer
      [eOasysNetwork.shibuya]: '0x175d905470e85279899C37F89000b195f3d0c0C5',
    },
    network
  );
  ...
  getParamPerNetwork<tEthereumAddress>(
    {
      ...
      [eOasysNetwork.astar]: '12960000', // Dummy
      [eOasysNetwork.shiden]: DISTRIBUTION_DURATION, // Dummy
      [eOasysNetwork.shibuya]: DISTRIBUTION_DURATION,
    },
    network
  );
  ...
  getParamPerNetwork<tEthereumAddress>(
    {
      ...
      [eOasysNetwork.astar]: '0x4C9d9C197880810724b8eCC3b47b279C9763EC2B',
      [eOasysNetwork.shiden]: '0x175d905470e85279899C37F89000b195f3d0c0C5', // Dummy
      [eOasysNetwork.shibuya]: '0x175d905470e85279899C37F89000b195f3d0c0C5', // Dummy
    },
    network
  );
